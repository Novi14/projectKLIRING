...
inline fun <reified T : ViewBinding> DialogFragment.viewBinding2() = DialogFragmentAlreadyBindingDelegate(T::class.java)

class DialogFragmentAlreadyBindingDelegate<T : ViewBinding>(private val bindingClass: Class<T>) :
